...
//            var ori_images = this.imageList;
//            var sort_images = [];
//            $('.filelist li p.title').each(function() {
//                for (var idx in ori_images) {
//                    if ($(this).text() == ori_images[idx].original) {
//                        sort_images.push(ori_images[idx]);
//                        continue;
//                    }
//                }
//            });
            ...
            var sort_images = {};
            $('.filelist li p.title').each(function() {
                sort_images[$(this).text()] = $('.filelist li p.title').index($(this));
            });

            ori_images.sort(function(v1, v2) {
                return sort_images[v1.original] - sort_images[v2.original];
            });

            for (i = 0; i < ori_images.length; i++) {
                data = ori_images[i];
                list.push({
                    src: prefix + data.url,
