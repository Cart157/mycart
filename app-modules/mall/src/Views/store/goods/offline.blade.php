...
<ul class="nav nav-pills">
    <li class="active">
        <a href="/store/goods-offline">全部</a>
    </li>

    <li>
        <a href="/store/goods-offline">售完下架</a>
    </li>

    <li>
        <a href="/store/goods-offline">我下架的</a>
    </li>

    <li>
        <a href="/store/goods-offline">即将开始</a>
    </li>

    <li>
        <a href="/store/goods-offline">从未上架</a>
    </li>
</ul>
@endsection
                    ...
                    <thead>
                        ...
                        <tr class="tools-row">
                            ...
                            <th colspan="6">
                                ...
                                <button class="btn btn-xs btn-white btn-default op-onsell">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:;" class="op-onsell">上架</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
...
<link rel="stylesheet" href="/assets/mall/css/store.goods.depot.css">
@endsection
