...
@section('title', '卖家中心 - 退款售后管理 - 处理退货(已发货)申请')
...
@section('main-content')
    ...
    <div class="exchange">
        <div class="title">
            <ul>
                <li class="first li-already"><span></span>买家申请退货</li>
                <li class="second {!! $data->refund_status == 10 ? 'li-now' : 'li-already' !!}"><span></span>卖家处理退货申请</li>
                <li class="third
                ...
                @endif
                "><span></span>买家退货</li>
                <li class="fourth {!! $data->refund_status == 0 || $data->refund_status == 40 ? 'li-now' : '' !!}"><span></span>{!! $data->refund_status == 0 ? '已拒绝退货退款' : '退货退款完成' !!}</li>
            </ul>
        </div>
        <div class="content clearfix">
            ...
            <div class="container">
                <div class="inside">
                    <div class="left {!! $data->refund_status != 10 ? 'hide' : '' !!}">
                        ...
                        <!--操作-->
                        <div class="handle">
                            <button class="leftFirstButton">同意退货退款申请</button>
                    ...
                    <div class="leftExchangeFail {!! $data->refund_status == 0 ? '' : 'hide' !!}">
                        <div class="exchangeFail">
                            <p class="failTitle">已拒绝退货退款</p>
                            @if($data->refund_status == 0 && count($data->detail) == 1)
                            <p>拒绝退货退款时间：{{ $data->finished_at }}</p>
                    ...
                    <div class="leftConfirmGoods {!! $data->refund_status == 30 ? '' : 'hide' !!}">
                        ...
                        <div class="buyersAlready">
                            ...
                            <p>如买家有特殊要求请及时处理</p>
                            <div class="button">
                                <button class="firstButton">确认收货，同意退款</button>
                                <button class="secondButton">拒绝退款</button>
                            </div>
                        </div>
                        @endif
                    </div>
                ...
                <div class="consultHistory">
                    ...
                    <div class="info">
                        ...
                        <p>发起了退货退款申请，货物状态：已收到货，原因：{{ $data->reason }}，说明：{{ $data->description ? $data->description : '无' }}</p>
                    </div>
                </div>
                <!--客服留言-->
                <div class="service">
            ...
            <div class="right">
                ...
                <div class="goodsInfoThree">
                    ...
                    <p><span>要&emsp;&emsp;求：</span>退货退款</p>
