...
class SettingCrudController extends CrudController
{
    ...
    {
        $this->crud->setModel("Modules\Mall\Models\Setting");
        $this->crud->setEntityNameStrings(trans('base::settings.setting_singular'), '商城模块设置');
        $this->crud->setRoute(config('backpack.base.route_prefix', 'admin').'/mall/setting');
