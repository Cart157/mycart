...
class SystemNoticeController extends \BaseController
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $notices = Models\SystemNotice::where('user_id', $user_id)
                                          ->with('from_user')
            ...
            Models\SystemNotice::whereIn('id', $is_read_list)
                               ->update(['is_read' => 1]);
    ...
    public function index2()
    {
        ...
        try {
            ...
            $notice = Models\SystemNotice::search($condition)->each(function ($item) use ($user_id) {
            ...
            Models\SystemNotice::whereIn('id', $is_read_list)->update(['is_read' => 1]);
    ...
    public function destroy($id)
    {
        ...
        try {
            // 业务逻辑
            $system_notice = Models\SystemNotice::findOrFail($id);
